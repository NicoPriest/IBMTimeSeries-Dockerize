...
DEFAULT_PARAM_GRID = {
    #'rf__criterion': ['squared-error', 'absolute-error'],
...
if __name__ == "__main__":
    ...
    ap.add_argument('-c', '--countries',
                    help='Comma separated list of countries to predict revenue', default=False)
    args = ap.parse_args()

    if args.countries == False:
    ...
    scaler = StandardScaler(
        ) if args.scaler == 'ss' else RobustScaler()
    """
